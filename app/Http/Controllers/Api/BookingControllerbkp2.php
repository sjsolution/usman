...
class BookingControllerbkp2 extends Controller
{
    ...
    public function vendorOrderStatusChange(Request $request){
        $validator= Validator::make($request->all(),[
            ...
            'status'       => 'required|numeric|integer|in:0,1,2,3,4',
        ]);
        ...
        return response()->json(Api::apiSuccessResponse(__('Status successfully changed.')),200);
    }
