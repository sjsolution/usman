...
class SpTimeSlotRequests extends FormRequest
{
    /**
     ...
     */
     public function rules()
     {
         ...
         // ];
         return [
             // 'sun_from_time'   => 'required',
             // 'sun_to_time'     => 'required',
             // 'mon_start_time'   => 'required',
             // 'mon_end_time'     => 'required',
             // 'tues_start_time'  => 'required',
             // 'tues_end_time'    => 'required',
     ...
     {
         return [
             // 'sun_from_time.required'   => 'Sunday start time cannot be blank',
             // 'sun_to_time.required'     => 'Sunday end time cannot be blank',
