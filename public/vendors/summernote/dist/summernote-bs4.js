...
(function (global, factory) {
  ...
  var ui = {
      ...
      button: function ($node, options) {
          return renderer.create('<button type="button" class="note-btn btn btn-gradient-danger  btn-sm" role="button" tabindex="-1">', function ($node, options) {
              ...
              children: [
                  ...
                  this.ui.dropdown({
                      items: (backColor ? [
                          ...
                          '  <div>',
                          '    <button type="button" class="note-color-reset btn btn-gradient-danger " data-event="backColor" data-value="inherit">',
                          ...
                          (foreColor ? [
                              ...
                              '  <div>',
                              '    <button type="button" class="note-color-reset btn btn-gradient-danger " data-event="removeFormat" data-value="foreColor">',
