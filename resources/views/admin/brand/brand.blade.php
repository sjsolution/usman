...
<div class="card">
  <div class="card-body">
    ...
    <div class="row">
      <div class="col-md-3">
          <h3 class="page-title">Vehicle brand list</h3>
      </div>
      <div class="col-md-5"></div>
      <div class="col-md-4 text-right">
        <a id="add_vehicle" href="{{route('vehicle.createbrand')}}" class="btn btn-gradient-danger btn-md btn-fill">Add +</a>
      </div>
    </div>
        </div>
    </form>
...
$(function() {
  ...
  $('#users-table').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{!! route('vehicle.brandlist.type') !!}',
      "columns": [
