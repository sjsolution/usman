...
<style>
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
          ...
          <form class="forms-sample" id="formdata" action="{{route('category.updateCategory',$category->id)}}" method="POST" enctype="multipart/form-data" autocomplete="off">
            @csrf
              <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <select name="type" id="status" class="form-control" required>
                        ...
                        @foreach ($typesArray as $key => $value)
                          <option value="{{ $key }}" @if($key ==$category->type ){{ 'selected' }} @endif>{{ $value }}</option>
                        @endforeach
                      </select>
                    </div>
                    @if ($errors->has('type'))
            ...
            <div class="raw">
                <div class="col-md-6">
                  ...
                  <img class='tableimage' src="{{config('app.AWS_URL').$category->image}}">
                @endif
                </div>
            </div>
            <br>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                  <label class="switch">
                    <input type="checkbox" class="switch-input" name="is_apply" id="is_apply" {{ ( $category->is_apply_user_app_fee == 1 ) ? 'checked' : '' }}>
            ...
            <div class="row">
              <div class="col-md-6">
                  ...
                  <input type="number" min="0" class="form-control" name="fixed_price" id="fixed_price" value="{{ $category->fixed_price }}">
                  </div>
              ...
              <div class="col-md-6">
                  ...
                  <input type="number"  min="0" max="100" class="form-control arabic_name" name="commission_percent" value="{{ $category->commission_percent }}">
                  </div>
          ...
          <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" maxlength="50" class="form-control" name="field_name" id="field_name" value="{{ $category->user_applicable_fee_name }}">
                </div>
            ...
            <div class="col-md-6">
              ...
              <input type="text" maxlength="50" class="form-control" name="field_name_ar" id="field_name_ar" value="{{ $category->user_applicable_fee_name_ar }}">
              </div>
              @if ($errors->has('field_name'))
              <span class="invalid-feedback" role="alert">
                  <strong>{{ $errors->first('field_name') }}</strong>
