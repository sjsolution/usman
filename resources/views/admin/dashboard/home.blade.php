...
<br><br>
  ...
  @endphp
  @if($user->type == 1 || $user->type == 2 && !empty($roleUserPermission) && ($roleUserPermission->is_write == 1 || $roleUserPermission->is_read == 1))
  <div class="row">
      ...
      <div class="card bg-gradient-danger card-img-holder text-white">
        <div class="card-body">
          ...
          <h4 class="font-weight-normal mb-3">
            <a href="{{ url('admin/user') }}" class="a-custom">Users (Today/Total)<i class="mdi mdi-chart-line mdi-24px float-right"></i></a>
          </h4>
        <h2 class="mb-5" id="user_stat">{{ $todayUser  }}/ {{ $totalUser }}</h2>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-info card-img-holder text-white">
          <div class="card-body">
            <img src="{{asset('images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
            <h4 class="font-weight-normal mb-3">
                <a href="{{ url('admin/serviceproviderlist') }}" class="a-custom">Service Providers (Today/Total) <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i></a>
            </h4>
          <h2 class="mb-5" id="vendor_stat">{{ $todayServiceProvider  }}/{{ $totalServiceProvider}}</h2>
    ...
    <div class="col-md-4 stretch-card grid-margin">
      <div class="card bg-gradient-success card-img-holder text-white">
        <div class="card-body">
          <img src="{{asset('images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
          <h4 class="font-weight-normal mb-3">
              <a href="{{ url('admin/booking/list') }}" class="a-custom">Orders (Today/Total) <i class="mdi mdi-diamond mdi-24px float-right"></i></a>
          </h4>
        <h2 class="mb-5" id="order_stat">{{ $todayOrders }}/ {{ $totalOrders }}</h2>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4 stretch-card grid-margin">
      <div class="card bg-gradient-danger card-img-holder text-white">
        <div class="card-body">
          <img src="{{asset('images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
          <h4 class="font-weight-normal mb-3">Revenue (Today/Total)<i class="mdi mdi-chart-line mdi-24px float-right"></i>
          </h4>
        <h2 class="mb-5" id="revenue_stat">{{ $todayRevenue  }} / {{ $totalRevenue }}</h2>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 stretch-card grid-margin">
      <div class="card bg-gradient-info card-img-holder text-white">
        <div class="card-body">
          <img src="{{asset('images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
          <h4 class="font-weight-normal mb-3">Total Active Service <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
          </h4>
...
$(document).ready(function(){
    ...
    setInterval(function(){
        $.ajax({
            ...
            if(response){
                $('#user_stat').html(response.todayUser+' / '+response.totalUser);
                $('#vendor_stat').html(response.todayServiceProvider+' / '+response.totalServiceProvider);
                $('#order_stat').html(response.todayOrders+' / '+response.totalOrders);
...
function orderList(){
  ...
  var bookingListRequest = fetchRequest('/admin/dashboard/booking/order/list');
...
function revenueChart(){
  ...
  var revenueListRequest = fetchRequest('/admin/dashboard/revenue/graph');
...
function orderChart(){
  ...
  var orderListRequest = fetchRequest('/admin/dashboard/order/graph');
    ...
    %}
      ...
      <tr class="{%=bLing%}">
        ...
        <td>
          ...
          <a href ="{{ url('admin/booking/invoice/') }}/{%=item.id%}" ><i class="fa fa-download ikn"  data-toggle="tooltip" data-placement="top" title="Invoice"></i></a>
        </td>
