...
<div class="card">
  <div class="card-body">
    ...
    <div class="row">
      <div class="col-md-5">
          <h3 class="page-title">Vehicle manufacturing year list</h3>
      </div>
      <div class="col-md-3"></div>
      <div class="col-md-4 text-right">
        <a id="add_vehicle" href="{{route('vehicle.createmanufacture')}}" class="btn btn-gradient-danger btn-md btn-fill"> Add +</a>
    </div>
  </div>
        </div>
  </form>
...
$(function() {
  ...
  $('#users-table').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{!! route('vehicle.manufacturelist.view') !!}',
      "columns": [
          {data: 'vehicle_model_name', name: 'vehicle_model_name'},
...
$(function () {
      ...
      $(document).on("click",".deletevehicle",function(){
        ...
        swal({
        title: 'Are you sure?',
        text: "You want to delete the manufactring year  "+name+"!",
        ...
        if(isConfirm){
          $.ajax({
            url: "{{route('vehicle.deletemanufacture')}}",
            method: 'POST',
            data:{id:id},
            type:"json",
