...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        ...
        <h3 class="page-title">Add Vehicle</h3>
            ...
            <form class="forms-sample" id="formdata" action="{{route('vehicle.createvehicle')}}" data-validate-parsley  method="post"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Name </label>
                            <input type="text" maxlength="20" class="form-control name_en" name="name_en" placeholder="Name"
                                required=" ">
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                                ...
                                <input type="file" name="image" class="file-upload-default" accept="image/x-png,image/gif,image/jpeg" required>
                              </div>
                            @if ($errors->has('image'))
                            <span class="invalid-feedback" role="alert">
