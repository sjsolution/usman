  ...
  <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-right">
        <a id="add_vehicle" href="{{route('vehicle.createvehicle')}}" class="btn btn-gradient-danger btn-md btn-fill">Add +</a>
...
$(document).on("click",".deletevehicle",function(){
  ...
  swal({
  title: 'Are you sure?',
  text: "You want to delete the vehicle "+name+"!",
  ...
  if(isConfirm){
    $.ajax({
      url: "{{route('vehicle.deleteVehicle')}}",
      method: 'POST',
      data:{id:id},
      type:"json",
