		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6" style="padding: 30px 50px">
					<h1 class="mb-5" style="color: #fff; font-size: 70px">Online store design</h1>
					...
					<p class="text-white">
						Websites are designed with the highest quality in terms of design, which saves our
						customers from modifying in the future Where we take into account all the options that
						the customer may need so that he does not have to design the site Again which may cost
						money and time.
					</p>
				</div>
					...
					<div class="row align-items-center">
						<div class="col-md-3">
							<div class="text-center my-5">
								...
								<p class="text-white mt-4">We provide a safe site</p>
							</div>
						</div>
						<div class="col-md-3">
							<div class="text-center my-5">
						...
						<div class="col-md-3">
							<div class="text-center my-5">
								...
								<p class="text-white mt-4">We provide you with a number of e-mail</p>
							</div>
						</div>
						<div class="col-md-3">
							<div class="text-center my-5">
								<img src="{{ asset('assets/img/icon-4.png') }}" class="img-fluid" alt="icon" />
								<p class="text-white mt-4">The website is compatible with all devices</p>
							</div>
						</div>
					</div>
				</div>
