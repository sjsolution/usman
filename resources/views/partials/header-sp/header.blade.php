<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class=" navbar-brand-wrapper d-flex align-items-center justify-content-center">
    <a class="navbar-brand brand-logo" href="{{route('user.home')}}"><img src="{{asset('images/DashLogo.png')}}" alt="logo" /></a>
  <a class="navbar-brand brand-logo-mini" href="{{route('user.home')}}"><img src="{{asset('images/DashbaordLogo.png')}}" alt="logo" /></a>
  </div>
      ...
      <li class="nav-item nav-profile dropdown">
        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
          ...
          <div class="nav-profile-text">
            <p class="mb-1 text-black">{{ Auth::user()->full_name_en }}</p>
          </div>
        </a>
        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
          <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="{{route('sp.profileUpdate')}}">
                <!-- <a class="dropdown-item" href="#"> -->
                  <i class="mdi mdi-cached mr-2 text-success"></i> Profile </a>
                  <a class="dropdown-item" href="{{route('sp.changepassword')}}">
