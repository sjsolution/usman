...
Route::namespace('Api')->group(function () {
  ...
  Route::prefix('admin')->group(function(){
    Route::post('admin-login','ServiceProvider\AuthController@adminLogin');
    Route::post('admin-recent-bookings', 'BookingController@adminRecentBookings');
    Route::post('admin-order-detail', 'BookingController@adminOrderDetail');
    Route::post('order-status-change', 'BookingController@adminOrderStatusChange');
  });
  ...
  Route::post('service_provider/recent_bookings', 'BookingController@vendorRecentBookings');
  Route::post('service_provider/order_detail', 'BookingController@vendorOrderDetail');
  Route::post('service_provider/order_status_change', 'BookingController@vendorOrderStatusChange');
  /**
  ...
  Route::post('newvehicleandtimeslot','VehicleController@newvehicleandtimeslot');

  Route::post('listofvehicleandtype','VehicleController@listofvehicleandtype');
  Route::post('listofdetailbytype','VehicleController@getDtailByType');
